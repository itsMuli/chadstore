  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3">
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        <div>
          <p className="mb-2 mt-3">Product Category</p>
          <select
        ...
        <div>
          <p className="mb-2 mt-3">Sub Category</p>
          <select
        ...
        <div>
          <p className="mb-2 mt-3">Product Price</p>
          <input
      ...
      <div>
        <p className="mb-2 mt-3">Product Sizes</p>
